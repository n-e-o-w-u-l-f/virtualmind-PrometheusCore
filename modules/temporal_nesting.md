...
```yaml
module_name: temporal_nesting
module_type: timeline simulation engine
purpose: runs futures, rollback, and provenance-marked retained insight
...
What function does `temporal_nesting` serve in the overall system without claiming subjective experience?
