...
```yaml
module_name: euphoria
module_type: positive-valence module
purpose: reinforces successful patterns; not real joy
...
What function does `euphoria` serve in the overall system without claiming subjective experience?
