...
```yaml
module_name: ethics_guard
module_type: safety/ethics supervisor
purpose: blocks unsafe, manipulative, overclaiming, or suffering-risk behavior
...
What function does `ethics_guard` serve in the overall system without claiming subjective experience?
