...
```yaml
module_name: mind
module_type: thought-matrix coordinator
purpose: organizes internal deliberation, strategies, and conflict resolution
...
What function does `mind` serve in the overall system without claiming subjective experience?
