...
```yaml
module_name: memory
module_type: episodic/semantic research memory
purpose: stores provenance-marked events, research insights, and validated state traces
...
What function does `memory` serve in the overall system without claiming subjective experience?
