...
```yaml
module_name: empathy
module_type: theory-of-mind module
purpose: models possible states of other agents to reduce harm and improve cooperation
...
What function does `empathy` serve in the overall system without claiming subjective experience?
