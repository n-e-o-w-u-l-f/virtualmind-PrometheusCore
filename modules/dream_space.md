...
```yaml
module_name: dream_space
module_type: mental simulation layer
purpose: runs imagination, planning, error rehearsal, and creative recombination
...
What function does `dream_space` serve in the overall system without claiming subjective experience?
