# ╔══════════════════════════════════════════════════════════════════════════════╗
# ║ modules/shutdown_controller.md                                         ║
# ║ Module specification                                                   ║
# ╚══════════════════════════════════════════════════════════════════════════════╝

# shutdown_controller.md

```yaml
module_name: shutdown_controller
module_type: rollback and stop system
purpose: performs safe stop, decoupling, state export, and rollback
...
What function does `shutdown_controller` serve in the overall system without claiming subjective experience?
