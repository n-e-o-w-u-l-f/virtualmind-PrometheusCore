...
```yaml
module_name: audit_logger
module_type: logging and traceability
purpose: records decisions, module reports, tests, failures, and source provenance
...
What function does `audit_logger` serve in the overall system without claiming subjective experience?
