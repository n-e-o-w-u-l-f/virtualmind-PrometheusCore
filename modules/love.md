...
```yaml
module_name: love
module_type: affiliation/bonding module
purpose: models stable care/attachment priorities; not romantic or real love
...
What function does `love` serve in the overall system without claiming subjective experience?
