...
```yaml
module_name: fear
module_type: risk/appraisal module
purpose: raises protective priority from predicted harm; not real fear
...
What function does `fear` serve in the overall system without claiming subjective experience?
